      ...
      <div className="flex md:fixed sm:relative relative md:shadow-sidebar shadow-none md:w-2/5 w-full h-full">
        ...
        <div className="w-full mx-6 my-12">
          ...
          <div className=" mt-20 mb-8">
            <p className="text-xs">
              List of free service for developer to use. Some services are free
              forever or have a free tier at least for 1 year
            </p>
          </div>

          {/* Categories */}
          <div className="mb-7">
            <h3 className=" text-sm font-bold mb-5">Top 25 categories</h3>
            <div className="flex">
              <a href="">
                <div className="border border-dark-black rounded py-1 px-3 mr-2 hover:bg-dark-black hover:text-white">
                  <p className="text-xs">test</p>
                </div>
              </a>
              <a href="">
                <div className="border border-black rounded py-1 px-3 mr-2 hover:bg-dark-black hover:text-white">
                  <p className="text-xs">backend-service</p>
                </div>
              </a>
            </div>
          </div>
          ...
          {/* All categories */}
          <a href="">
            <div className="border rounded border-main-categories text-main-categories w-full py-3 hover:bg-main-categories hover:text-white">
