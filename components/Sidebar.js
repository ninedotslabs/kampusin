        ...
        <div className="grid grid-cols-4 gap-6 relative">
            <a href="https://github.com/ninedotslabs/kampusin/blob/main/CONTRIBUTING.md">
              <div className="flex border px-5 py-2 border-write shadow-write rounded absolute hover:top-1 text-main-write hover:bg-main-write hover:shadow-none hover:text-white">
                <svg className="w-3 mr-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pencil" className="svg-inline--fa fa-pencil" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M497.9 74.16l-60.09-60.1c-18.75-18.75-49.19-18.75-67.93 0L313.4 70.61l127.1 128l56.56-56.55C516.7 123.3 516.7 92.91 497.9 74.16zM31.04 352.1c-2.234 2.234-3.756 5.078-4.377 8.176l-26.34 131.7C-1.703 502.1 6.156 512 15.95 512c1.049 0 2.117-.1035 3.199-.3203l131.7-26.34c3.098-.6191 5.941-2.141 8.176-4.373l259.7-259.7l-128-128L31.04 352.1zM131.9 440.2l-75.14 15.03l15.03-75.15L96 355.9V416h60.12L131.9 440.2z"></path></svg>
                <p className="text-xs m-auto">Write</p>
              </div>
            </a>

            <a href="https://medium.com/nine-dots-labs">
              <div className="flex border px-5 py-2 border-blog shadow-blog rounded text-main-blog hover:bg-main-blog hover:text-white absolute hover:top-1 hover:shadow-none">
                <svg className="w-3 mr-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="lightbulb" className="svg-inline--fa fa-lightbulb" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M112.1 454.3c0 6.297 1.816 12.44 5.284 17.69l17.14 25.69c5.25 7.875 17.17 14.28 26.64 14.28h61.67c9.438 0 21.36-6.401 26.61-14.28l17.08-25.68c2.938-4.438 5.348-12.37 5.348-17.7L272 415.1h-160L112.1 454.3zM191.4 .0132C89.44 .3257 16 82.97 16 175.1c0 44.38 16.44 84.84 43.56 115.8c16.53 18.84 42.34 58.23 52.22 91.45c.0313 .25 .0938 .5166 .125 .7823h160.2c.0313-.2656 .0938-.5166 .125-.7823c9.875-33.22 35.69-72.61 52.22-91.45C351.6 260.8 368 220.4 368 175.1C368 78.61 288.9-.2837 191.4 .0132zM192 96.01c-44.13 0-80 35.89-80 79.1C112 184.8 104.8 192 96 192S80 184.8 80 176c0-61.76 50.25-111.1 112-111.1c8.844 0 16 7.159 16 16S200.8 96.01 192 96.01z"></path></svg>
                <p className="text-xs m-auto">Blog</p>
              </div>
            </a>

            <a href="https://github.com/ninedotslabs">
          ...
          <div className=" mt-20 mb-8">
            <p className="text-xs">
            This website provides a list of universities in Indonesia for high school students. You can see the name of the university and its address. 
            *Help: Click on the name to go to the campus official website
            </p>
          </div>
      </div>
    </div>
